    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'productCtaLabel', type: 'text', label: 'Button label', defaultValue: 'Explore Metron Products' },
        {
          ...
          type: 'text',
          label: 'Image URL',
          defaultValue: 'https://images.unsplash.com/photo-1681108212545-04cabe9cf771?auto=format&fit=crop&w=1100&q=72',
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          type: 'text',
          label: 'CTA heading',
          defaultValue: 'Talk to the team that will do the work.',
        },
        {
          name: 'ctaSubtitle',
          type: 'text',
          label: 'CTA subtitle',
          defaultValue: 'Get a quote — typically within two business days',
        },
      ],
    },
  ],
